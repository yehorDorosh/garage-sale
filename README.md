...
docker tag garage-sale:1.0.1 egordoroshv/garage-sale:1.0.1

# Use docker account name and pass
$ docker login

# Push to repo
$ docker push egordoroshv/garage-sale:1.0.1
```

## Run container on EC2

```bush
sudo docker run -d --rm -p 80:80 --env-file .env egordoroshv/garage-sale:1.0.1
```
...
```bash
# Build image
$ docker build -t egordoroshv/garage-sale:1.0.1 -f prod.dockerfile .
...
$ sudo docker pull egordoroshv/garage-sale:1.0.1

$ docker-compose -f docker-compose.prod.yaml pull garage-sale

# Run container (docker or docker compose)
sudo docker run -d --rm -p 80:80 -p 443:443 --name garage-sale --env-file ./.env egordoroshv/garage-sale:1.0.1
